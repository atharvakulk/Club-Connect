  ...
  <style>
    * {
    ...
    form.register input {
      ...
      width: calc(70% - 20px); /* Adjust width for padding */
...
<div class="container">
<div id="newUser">
  <form name="newUser" class="register" action="ach.php" method="post">
    <h1>Acheivements</h1>
    <fieldset class="row1">
      <left><legend>Achievement Details</legend></left>
      <div class="form-group">
        <div class="row input-row">
            <label for="committee_ID">Achievement Name</label>
            <input type="text" id="committee_ID" name="name" placeholder="Enter achievement name..">
          </div>
        
        <div class="row input-row">
          <label for="objective">Description</label>
          <textarea id="objective" name="desc" placeholder="Write something.." style="height:200px"></textarea>
        </div>
        <div class="row input-row">
          <label for="about_us">Achievement Date</label>
          <input type="date" id="committee_ID" name="date" placeholder="Enter date...">
        </div>
        
        <div class="row input-row">
          <label for="logo">Upload photo</label>
          <input type="file" id="logo" name="photo" accept="image/*">
        </div>
      </div>

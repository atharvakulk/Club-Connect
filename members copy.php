...
if(isset($_GET['committee_ID'])) {
    ...
    // Prepare SQL statement to retrieve data for the specific committee ID from members table
    $sql_members = "SELECT * FROM members WHERE committee_ID = ?";
    ...
    // Display an error message if the committee ID is not set in the URL
...
<main>
    ...
    <div class="user-info-bar">
        ...
        <div class="ufo-bar-col3">
            <div class="ufo-bar-col3-inner">
                ...
                <a style="text-decoration:none; color: black;" href="memberform.php?committee_ID=<?php echo $committee_id?>"><button onclick="myFunction()">Add Member</button></a>
            </div>
        </div>
        <div class="nav-right">
        <!-- <ul id="navbar-items">
    ...
    <div class="user-info-bar2">
        ...
        <div id="ufo-home" class="ufo-bar2-col2 ufo-bar2-block">
            <div class="ufo-bar2-col2-inner flexbox">
                ...
                <a style="text-decoration: none;" href="committeepg copy.php?committee_ID=<?php echo $committee_id; ?>"><h3>About</h3></a>
            </div>
        </div>
        <div id="ufo-videos" class="ufo-bar2-col3 ufo-bar2-block">
            <div class="ufo-bar2-col3-inner flexbox">
                ...
                <a style="text-decoration: none;" href="events copy.php?committee_ID=<?php echo $committee_id; ?>"><h3>Events</h3></a>
            </div>
        </div>
        <div id="ufo-images" class="ufo-bar2-col4 ufo-bar2-block">
            <div class="ufo-bar2-col4-inner flexbox">
                ...
                <a style="text-decoration: none;" href="achievements copy.php?committee_ID=<?php echo $committee_id; ?>"><h3>Achievements</h3></a>
            </div>
        </div>
        <div id="ufo-about" class="ufo-bar2-col6 ufo-bar2-block">
            <div class="ufo-bar2-col6-inner flexbox">
                ...
                <a style="text-decoration: none;" href="members copy.php?committee_ID=<?php echo $committee_id; ?>"><h3>Members</h3></a>
    ...
    <!--section class="about">
        <h1 class="about-align">Members</h1>
        <div class="about-flex">
        
foreach ($committee_members as $member) {
    echo "<div class='rectangle'>";
    $imageData = base64_encode($member['photo']); // Assuming 'photo' contains the binary image data
    echo "<img src='data:image/jpeg;base64,{$imageData}' alt='Member Photo' style='width: 200px; height: 120px;'>"; // Adjust the width as needed
    echo "<h4>Name: </h4><h6>" . $member['member_name'] . "</h6>";
    echo "<h4>Position: </h4><h6>" . $member['position'] . "</h6>";
    echo "</div>";
}
?>
        </div>
    ...
    $total_members = count($committee_members);
    ...
    foreach ($committee_members as $member) {
        ...
        echo "<div class='rectangle'>";
        $imageData = base64_encode($member['photo']); // Assuming 'photo' contains the binary image data
        echo "<img src='data:image/jpeg;base64,{$imageData}' alt='Member Photo' style='width: 200px; height: 180px;'>"; // Adjust the width as needed
        echo "<strong><br>" . $member['member_name']. "</strong>";
        echo "<strong><br>" . $member['position'] . "</strong>";
        echo "</div>";

        $counter++;
        
        if ($counter % 3 == 0 || $counter == $total_members) {

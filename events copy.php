...
if(isset($_GET['committee_ID'])) {
    ...
    mysqli_stmt_bind_param($stmt_events, "i", $committee_id);
    mysqli_stmt_execute($stmt_events);
    $result_events = mysqli_stmt_get_result($stmt_events);

    // Fetch all events and store their attributes into variables
    $events = [];
...
/* Default styles for the text box */
#myTextBox {
...
<main>
    ...
    <div class="user-info-bar">
        ...
        <div class="ufo-bar-col3">
            <div class="ufo-bar-col3-inner">
                ...
                <a style="text-decoration:none; color: black;" href="eventform.php?committee_ID=<?php echo $committee_id?>"><button onclick="myFunction()">Add New Event</button></a>
            </div>
        </div>
        <div class="nav-right">
        <!-- <ul id="navbar-items">
    ...
    <section class="about">
        <h1 class="about-align">Events</h1>
        <div class="div-align">
        <?php
    if (!empty($events)) {
        foreach ($events as $event) {
          ?> <div class="rectangle" id="myTextBox"> <?php
            echo "<h2>{$event['eventName']}</h2>". "<br>";
            echo "{$event['e_desc']}". "<br><br>";
            echo "<strong>Date:</strong>" . date('d.m.y',strtotime($event['event_date'])). "<br>";
            echo "<strong>Resource Person:</strong> {$event['RpersonName']}". "<br>";
            echo "<strong>Contact:</strong> {$event['RpersonContact']}". "<br>";
           ?></div><br><?php
        }
    } else {
        echo "No events found for this committee.";
    }
    ?> </div> <br> 
       <!-- <div class="rectangle">07 <br>JUL</div> <br>
       <div class="rectangle">07 <br>JUL</div><br>
       <div class="rectangle">07 <br>JUL</div> -->
    </div>
    <br><br><br><br>
    </section>    
</main><br><br>

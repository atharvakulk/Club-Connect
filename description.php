...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt_check = mysqli_prepare($link, $sql_check)) {
        ...
        if (mysqli_stmt_num_rows($stmt_check) > 0) {
            ...
            $sql_update = "UPDATE descriptions SET objective = ?, misson = ?, more = ? WHERE committee_ID = ?";
            if ($stmt_update = mysqli_prepare($link, $sql_update)) {
                mysqli_stmt_bind_param($stmt_update, "ssss", $objective, $about_us, $more_desc, $committee_ID);
            ...
            // Insert a new row
            $sql_insert = "INSERT INTO descriptions (misson, objective, more, committee_ID) VALUES (?, ?, ?, ?)";
            if ($stmt_insert = mysqli_prepare($link, $sql_insert)) {
                mysqli_stmt_bind_param($stmt_insert, "ssss", $objective, $about_us, $more_desc, $committee_ID);
    ...
    header("Location: c_committeepg.php?committee_ID=". urlencode($committee_ID));
    exit;
}
else {
...
<div class="container">
<div id="newUser">
  <form name="newUser" class="register" onsubmit="return userRegistration(this);"  action="event.php" method="post">
    ...
    <fieldset class="row1">
      ...
      <div class="form-group">
        <div class="row input-row">
          ...
          <input type="text" id="committee_ID" name="committee_ID" placeholder="Enter committee_ID">
        </div>
        <div class="row input-row">
      ...
      <input type="hidden" name="redirect_url" value="committeepg.php">

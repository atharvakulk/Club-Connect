    ...
    <div class="user-info-bar">
        ...
        <div class="ufo-bar-col3">
            <div class="ufo-bar-col3-inner">
                ...
                <a style="text-decoration:none; color: black;" href="descriptionform.php?committee_ID=<?php echo $committee_id?>"><button onclick="myFunction()">Edit About Page</button></a>
            </div>
        </div>
        <div class="nav-right">
        <!-- <ul id="navbar-items">

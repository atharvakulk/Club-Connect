    ...
    <div class="user-info-bar">
        ...
        <div class="ufo-bar-col3">
            <div class="ufo-bar-col3-inner">
                ...
                <a style="text-decoration:none; color: black;" href="achievementsform.php?committee_ID=<?php echo $committee_id?>"><button onclick="myFunction()">Add Achievement</button></a>
            </div>
        </div>
        <div class="nav-right">
        <!-- <ul id="navbar-items">
